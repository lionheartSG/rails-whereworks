...
puts "Created user"
  listing_workthere_cec = Listing.create(
    name: "Workthere Singapore",
    address: "30 Cecil St, Level 20 Prudential Tower, Singapore 049712",
  ...
  listing_workthere_win = Listing.create(
    name: "Workthere Singapore",
    address: "10 Winstedt Rd, Singapore 227977",
    listing_type: "Coworking Space",
    booking_type: "Room",
    description: "Workthere is a business by Savills, formed in February 2017 to help clients looking for flexible office space.",
    price: 15,
    user: user_alex
  )
  puts "Created listing"
...
puts "Created user"
  listing_sb_fu = Listing.create(
    ...
    address: "1 Fusionopolis Way, #01-07 / #02-14, Singapore 138632",
    listing_type: "Cafe",
    booking_type: "Table",
  ...
  listing_sb_ma = Listing.create(
    ...
    address: "6 Raffles Blvd, #03-217/218 Marina Square, Singapore 039594",
    listing_type: "Cafe",
    booking_type: "Table",
...
puts "Created user"
  ...
  puts "Created listing"
  listing_wework_an =Listing.create(
    name: "WeWork",
